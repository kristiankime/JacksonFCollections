...
public abstract class T10MixIn<A, B, C, D, E, F, G, H, I, J> {
	T10MixIn(@JsonProperty("_1") A _1, @JsonProperty("_2") B _2, @JsonProperty("_3") C _3, @JsonProperty("_4") D _4, @JsonProperty("_5") E _5, @JsonProperty("_6") F _6, @JsonProperty("_7") G _7, @JsonProperty("_8") H _8, @JsonProperty("_9") I _9, @JsonProperty("_10") I _10) { }
}
