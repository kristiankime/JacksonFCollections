...
public abstract class T6MixIn<A, B, C, D, E, F> {
	T6MixIn(@JsonProperty("_1") A _1, @JsonProperty("_2") B _2, @JsonProperty("_3") C _3, @JsonProperty("_4") D _4, @JsonProperty("_5") E _5, @JsonProperty("_6") F _6) { }
}
