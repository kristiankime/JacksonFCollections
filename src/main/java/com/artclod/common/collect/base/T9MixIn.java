...
public abstract class T9MixIn<A, B, C, D, E, F, G, H, I> {
	T9MixIn(@JsonProperty("_1") A _1, @JsonProperty("_2") B _2, @JsonProperty("_3") C _3, @JsonProperty("_4") D _4, @JsonProperty("_5") E _5, @JsonProperty("_6") F _6, @JsonProperty("_7") G _7, @JsonProperty("_8") H _8, @JsonProperty("_9") I _9) { }
}
